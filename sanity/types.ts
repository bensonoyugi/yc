...
// Query: *[_type == "startup" && _id == $id][0] | order(_createdAt desc){    _id,    title,    slug,    _createdAt,    author -> {    _id, name, image, bio    },    views,    description,    category,    image,    pitch    }
export type STARTUP_BY_ID_QUERYResult = null;
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    "*[_type == \"startup\" && _id == $id][0] | order(_createdAt desc){\n    _id,\n    title,\n    slug,\n    _createdAt,\n    author -> {\n    _id, name, image, bio\n    },\n    views,\n    description,\n    category,\n    image,\n    pitch\n    }": STARTUP_BY_ID_QUERYResult;
  }
}
